...
describe('Auto-Updater Security Tests', () => {
  ...
  describe('Certificate Validation', () => {
    ...
    test('should validate certificate chain', async () => {
      const validateCertificateChain = async () => {
        ...
        if (root && root.subject !== root.issuer) {
  ...
  describe('Update Integrity', () => {
    test('should verify update file hash', async () => {
      const verifyUpdateHash = async (_filePath: string, expectedHash: string) => {
    ...
    test('should validate update file size', async () => {
      const validateFileSize = async (_filePath: string, expectedSize: number) => {
